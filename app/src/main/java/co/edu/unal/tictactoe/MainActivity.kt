...
class MainActivity : ComponentActivity() {
    ...
    private fun updateScoreboard() {
        ...
        findViewById<TextView>(R.id.human_wins).text = "Human: $humanScore"
        findViewById<TextView>(R.id.ties).text = "Ties: $tieScore"
        findViewById<TextView>(R.id.android_wins).text = "Computer: $computerScore"
    }
